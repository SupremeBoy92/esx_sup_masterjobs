Electricista                            = {}
Electricista.DrawDistance               = 20.0
Electricista.nameJob                    = "electricista"
Electricista.nameJobLabel               = "Electricista"
Electricista.platePrefix                = "LSWP"
Electricista.PagoMax                    = 50
Electricista.PagoMin                    = 20

Electricista.Vehicles = {
	Truck = {
		Spawner = 1,
...
Electricista.Zones = {
  ...
  VehicleSpawner = {
	...
	BlipSprite = 354,
	BlipColor = 46,
	BlipName = Electricista.nameJobLabel.." : Vehicle",
  ...
  VehicleDeleter = {
	...
	BlipSprite = 354,
	BlipColor = 46,
	BlipName = Electricista.nameJobLabel.." : Return Vehicle",
...
for i=1, #Electricista.Pool, 1 do

    Electricista.Zones['Pool' .. i] = {
        Pos   = Electricista.Pool[i],
...
Electricista.Locales = {
	['GPS_info'] = 'A new job has been highlighted on your GPS',
	['cancel_mission'] = 'You have cancelled the mission',
	['pickup'] = 'Press ~INPUT_CONTEXT~ to inspect the work site',
	['end_service'] = 'End Service',
	['take_service'] = 'Take Service',
	['end_service_notif'] = 'Ended Service',
	['take_service_notif'] = 'Started Service',
	['start_job'] = 'Press F10 to start the job',
	['Vehicle_Menu_Title'] = 'Service Vehicle',
	['in_vehicle'] = 'You must be out of your vehicle!',
	['vehicle_broken'] = 'You need to repair the vehicle before continuing!',
	['bad_vehicle'] = 'You can only store the Service Vehicle',
	['not_good_veh'] = 'You must be in your service vehicle!',
	['stop_npc'] = 'Job Complete : Return to the depot',
	['pago'] = 'Has cobrado %s por el trabajo'
}
